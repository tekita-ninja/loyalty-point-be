...
export class RulePointService {
    ...
    async findOne(id: string) {
        await checkDataById<RulePoint>(id, this.prismaService.rulePoint, "rule point")
    ...
    async search(query: QueryParamDto) {
        ...
        return await paginate<RulePoint, Prisma.RulePointFindManyArgs>(this.prismaService.rulePoint, {
            where: query?.isActive
