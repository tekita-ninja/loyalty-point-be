...
export class TransactionService {
    ...
    async create(data: CreateTransactionDto) {
        ...
        await checkDataById(data.locationId, this.prismaService.location, 'locationId');
    ...
    async Search(query: QueryParamDto) {
         const paginate = createPaginator({
                ...
                if(query.locationId) {
                    await checkDataById(query.locationId, this.prismaService.location, 'locationId');
                ...
                if(query.rewardId) {
                    await checkDataById(query.rewardId, this.prismaService.reward, 'rewardId');
